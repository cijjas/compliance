...
- [x] Microservicio NestJS separado que valida formato de identificadores fiscales según país (comunicación
      vía HTTP)
...
- [x] Docker Compose para levantar todo el stack localmente (backend + microservicio de validación +
      PostgreSQL + frontend)
...
- [x] Repositorio GitHub/GitLab con código fuente completo
- [x] Docker Compose incluido en el repo
- [x] Colección de Postman incluida en el repo
- [x] (Opcional) Terraform files en carpeta `/infrastructure`
